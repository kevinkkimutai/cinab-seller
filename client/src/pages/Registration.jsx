...
export default function Registration() {
  ...
  const handleSubmit = async (e) => {
    ...
    formDataToSend.append("companyName", formData.brandName);
    ...
    try {
      const res = await createVendor(formDataToSend);
      if (!res.data) {
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="text-gray-500 font-medium">
                      If Your Category is Not here kindly contact: 071
                    </span>
                    ) */}
                  </label>
                  <select
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="*****************"
                    value={formData.password} // Assuming you want to use 'setFormData.password' as the input value
                    onChange={handleFormChange}
                    required
                  />
                  <button
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    >
                      ...
                      <a
                        href="https://cinabs.com/privacy-policy"
                        target="_blank"
