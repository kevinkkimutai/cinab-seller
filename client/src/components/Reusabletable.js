              ...
              <tbody>
                {isLoading ? (
                  ...
                  <tr>
                    <td
                      colSpan={columns.length + (actions ? 1 : 0)}
                      className="text-center py-4 text-gray-700 dark:text-gray-400"
                    >
                      No data available.
                    </td>
                  </tr>
                  ...
                  sortData(filteredData)
                    ...
                    .map((row, index) => (
                      <tr
                        key={row.id}
                        className={`border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-700 ${
                          isLoading
                            ? "bg-blue-500 animate-pulse"
                            : "odd:bg-primary-50 odd:dark:bg-gray-900 even:bg-gray-100 even:dark:bg-gray-800"
                        }`}
                      >
                        ...
                        {columns.map((column) => (
                          ...
                          >
                            {editStates[row.id] ? (
                              <input
                                type="text"
                                className="block w-full p-2 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                value={
                              ...
                              <div className="flex items-center space-x-2">
                                {onEdit && (
                                  <button
                                    ...
                                    className="px-2 py-0.5 text-sm font-medium text-white bg-primary-700 rounded-lg hover:bg-primary-800"
                                  >
                                    Edit
                                  </button>
                                )}
                                ...
                                {onReject && (
                                  <button
                                    ...
                                    className="px-1.5 py-0.5 text-sm font-medium text-white bg-red-700 rounded-lg hover:bg-red-800"
                                  >
                                    Reject
                                  </button>
                                )}
                                ...
                                {onView && (
                                  <button
                                    ...
                                    className="px-1.5 py-0.5 text-sm font-medium text-white bg-green-700 rounded-lg hover:bg-green-800"
                                  >
                                    View
                                  </button>
                                )}
