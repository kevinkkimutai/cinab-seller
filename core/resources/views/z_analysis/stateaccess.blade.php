...
@section('content')
    <script>
        ...
        function getDataDated(){
            ...
            if(startDate !="" && endDate !=""){
                location.href ="/stateaccess/"+startDate+"/"+endDate;
            }
        }
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            <div  class="row">
                <div class="col-md-6">
                    <h3 class="mb-0 px-3 py-4"><b>{{ __('State  Access ') }}</b></h3>
                </div>
                <div class="col-md-2">
    ...
    @if (Auth::guard('admin')->user()->id == 1)
        <!-- Content Row -->
            <div class="card-body">
                <div class="row">
                    @if (count($stateAccessed) > 0)
                        @foreach($stateAccessed as $data)
                                    ...
                                    <div class="card-body ">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col col-stats ml-3 ml-sm-0">
                                                <div class="numbers">
                                                    <p class="mb-0"><b>{{$data['countryName']}}</b></p>
                                                    <h4 class="card-title">{{generalController::countSate($data['countryName'],$startDate,$endDate)}}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
