<ul class="nav">
    ...
    <li class="nav-item">
        ...
        <div class="collapse" id="items">
            <ul class="nav nav-collapse">
               ...
               {{-- <li>
                    <a class="sub-link" href="{{ route('promotion') }}">
                        <span class="sub-item">{{ __('Product Promotion') }}</span>
                    </a>
                </li>--}}
                <li>
    ...
    <li class="nav-item {{ request()->is('reports/*') ? 'submenu' : '' }}">
        ...
        <div class="collapse" id="report">
            <ul class="nav nav-collapse">
                <li class="{{!request()->input('type') && request()->is('admin/reports')  ? 'active' : ''}}">
                    <a class="sub-link" href="{{ route('z_analysis.reportdashboard') }}">
                        <span class="sub-item">{{ __('Pages Accessed') }}</span>
                    </a>
                </li>

                <li class="{{!request()->input('type') && request()->is('admin/reportmap')  ? 'active' : ''}}">
                    <a class="sub-link" href="{{ route('z_analysis.reportmap') }}">
                        <span class="sub-item">{{ __('User Map Location') }}</span>
                    </a>
                </li>
                <li class="{{!request()->input('type') && request()->is('admin/state')  ? 'active' : ''}}">
                    <a class="sub-link" href="{{ route('z_analysis.stateaccess') }}">
                        <span class="sub-item">{{ __('State Access') }}</span>
                    </a>
                </li>
                <li class="{{!request()->input('type') && request()->is('admin/pagesvisited')  ? 'active' : ''}}">
                    <a class="sub-link" href="{{ route('z_analysis.pagesvisited') }}">
                        <span class="sub-item">{{ __('Page Visited') }}</span>
                    </a>
                </li>
            </ul>
        </div>
