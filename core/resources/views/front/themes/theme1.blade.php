...
<!--<video playsinline autoplay loop muted playsinline style="padding:1px"><source src="{{ asset('public/assets/images/slidervid5.mp4')}}" type="video/mp4"> </video>-->
 
    @if ($setting->is_slider == 1)
  {{-- Hero section container start --}}

    <div class="container hero justify-content-center py-4">
        <div class="row hero-items">
            {{-- Start of left div --}}
            <div class="col-4 col-md-3 left">
                <div class="left-top">
                    <a href="https://cinab.co.ke/catalog?category=&search=roto" class="h-100 offers">
                        <img class=" w-100 img-fluid" src="./public/assets/pics/tankup.png" alt="Unga"  style="border-radius: 2%">

                    </a>

                </div>
                <div class="left-bottom">
                   <a href="#offers" class="h-100 offers">
                        <img class=" w-100 img-fluid" src="./public/assets/pics/below-500.jpg" alt="Unga"
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                                ...
                                <img class="d-block w-100 img-fluid" src="./public/assets/pics/Oil.png"
                                    alt="oil">
                        ...
                        <div class="carousel-item">
                             <a href="https://cinab.co.ke/catalog?subcategory=Flour---Sugar">
                                <img class="d-block w-100 img-fluid" src="./public/assets/pics/Unga.png"
                                    alt="Unga" >
                        ...
                        <div class="carousel-item">
                                ...
                                <img class="d-block w-100 img-fluid" src="./public/assets/pics/electronics.png"
                                    alt="woofer">
            ...
            {{-- Start of Right div --}}
            <div class="col-3  left d-none d-md-block">
                <div class="left-top">
                                  <a href="https://cinab.co.ke/catalog?category=&search=roto" class="h-100 offers">
                        <img class=" w-100 img-fluid" src="https://img.freepik.com/free-vector/yellow-neon-flash-sale-sign_23-2149111858.jpg?size=626&ext=jpg&ga=GA1.1.280326501.1701852879&semt=ais" alt="Unga"  style="border-radius: 2%">
                  ...
                  <div class="left-bottom">
                    <div class="slider">
                        <div class="slider-container" id="imageSlider">
                            <div>
                                <img class="w-100 img-fluid" src="./public/assets/pics/buy.jpg" alt="Buy">
                            </div>
                            <div>
                                <img class="w-100 img-fluid" src="./public/assets/pics/Beko.jpg" alt="Beko">
                            </div>
                            <div>
                                <img class="w-100 img-fluid" src="./public/assets/pics/Vetron.jpg" alt="Vetron">
                            </div>
                            <div>
                                <img class="w-100 img-fluid" src="./public/assets/pics/von.jpg" alt="Von">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-2">
                        ...
                        <div class="slider-item">
                            <div class="product-card">
                                <div class="product-thumb">
                                        <a href="">
                                            <img class="lazy sld" src="{{ asset('assets/pics/New.png') }}" alt="Product"style="width: 100%!important;">
                                        </a>
                                </div>
                    ...
                    <div class="slider-item">
                            <div class="product-card">
                                <div class="product-thumb">
                                        <a href="">
                                            <img class="lazy sld" src="{{ asset('assets/pics/NYD.png') }}" alt="Product"style="width: 100%!important;">
                                        </a>
                                </div>
                                    <!-- <div class="product-card-body">
                    ...
                    <div class="slider-item">
                            <div class="product-card">
                                <div class="product-thumb">
                                        <a href="">
                                            <img class="lazy sld" data-src="./public/assets/pics/offer7.png" alt="Product"style="width: 100%!important;">
                                        </a>
                                </div>
                                    <!-- <div class="product-card-body">
                    ...
                    <div class="slider-item">
                            <div class="product-card">
                                <div class="product-thumb">
                                        <a href="">
                                            <img class="lazy sld" data-src="./public/assets/pics/offer4.png" alt="Product"style="width: 100%!important;">
                                        </a>
                                </div>
                                    <!-- <div class="product-card-body">
                    ...
                    <div class="slider-item">
                            <div class="product-card">
                                <div class="product-thumb">
                                        <a href="">
                                            <img class="lazy sld" data-src="./public/assets/pics/offer6.png" alt="Product"style="width: 100%!important;">
                                        </a>
                                </div>
                                    <!-- <div class="product-card-body">
                            ...
                            <div class="product-card">
                                <div class="product-thumb">
                                        <a href="">
                                            <img class="lazy sld" data-src="./public/assets/pics/offer2.png" alt="Product"style="width: 100%!important;">
                                        </a>
                                </div>
                                    <!-- <div class="product-card-body">
                            ...
                            <div class="product-card">
                                <div class="product-thumb">
                                        <a href="">
                                            <img class="lazy sld" data-src="./public/assets/pics/offer8.png" alt="Product"style="width: 100%!important;">
                                        </a>
                                </div>
                                    <!-- <div class="product-card-body">
                            ...
                            <div class="product-card">
                                <div class="product-thumb">
                                        <a href="">
                                            <img class="lazy sld" data-src="./public/assets/pics/offer3.png" alt="Product"style="width: 100%!important;">
                                        </a>
                                </div>
                                    <!-- <div class="product-card-body">
                            ...
                            <div class="product-card">
                                <div class="product-thumb">
                                        <a href="">
                                            <img class="lazy sld" data-src="./public/assets/pics/offer5.png" alt="Product"style="width: 100%!important;">
                                        </a>
                                </div>
                                    <!-- <div class="product-card-body">
...
@if ($slider->logo)
                rgb(0, 2, 41)     <img class="d-inline-block brand-logo"
                            src="{{ asset('public/assets/images/' . $slider->logo) }}"
                                                    alt="logo">
                                                @endif
                ...
                <!--
                    ...
                    <div class="col-lg-4 d-none d-lg-block">
                        <a href="{{$hero_banner['url1']}}" class="sright-image">
                            <img src="{{asset('public/assets/images/'.$hero_banner['img1'])}}" alt="">
                        ...
                        <a href="{{$hero_banner['url2']}}" class="sright-image mb-0">
                            <img src="{{asset('public/assets/images/'.$hero_banner['img2'])}}" alt="">
                            <div class="inner-content">
...
@foreach ($services as $service)
                        <div class="col-lg-3 col-sm-6 text-center mb-30">
                            <div class="single-service single-service2">
                                <img src="{{ asset('public/assets/images/'.$service->photo) }}" alt="Shipping">
                                <div class="content">
                            ...
                            @if($compaign_item->item->previous_price && $compaign_item->item->previous_price !=0)
                                <div class="product-badge product-badge2 bg-info"> -{{PriceHelper::DiscountPercentage($compaign_item->item)}}</div>
                                    ...
                                    <a href="{{route('front.product',$compaign_item->item->slug)}}">
                                                  <img class="lazy" data-src="{{asset('public/assets/images/'.$compaign_item->item->thumbnail)}}" alt="Product" style="width: 100%!important;">
                                                </a>
...
@endif
                        ...
                        <section class="newproduct-section popular-category-sec mt-20">
                            <div class="container">
                                <div class="row w-full download">
                                    <img class="download" src="{{ asset('assets/pics/running.png') }}" alt="download">
                                </div>
                            </div>
                        </section>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="brand-slider owl-carousel">
                                                ...
                                                <div class="left-bottom">
                                                    <a href="{{ route('front.catalog') . '?brand=' . $brand->slug }}" class="h-100 offers">
                                                         <img class=" w-100 img-fluid"     src="{{ asset('assets/pics/bidco1.png') }}" alt="Unga"
                                                             style="border-radius: 2%">
                                                     </a>
                                                 </div>
                                                @endforeach
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
      ...
      <script>
        ...
        const sliderImages = document.querySelectorAll('#imageSlider div');
