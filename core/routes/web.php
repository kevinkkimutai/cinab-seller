...
Route::get('/reportmap/{startDate}/{endDate}', 'zAnalysis\reportAnalysisController@reportMapsDates');
Route::get('/stateaccess/{startDate}/{endDate}', 'zAnalysis\reportAnalysisController@stateaccessDates');
Route::get('/pagesvisited/{startDate}/{endDate}', 'zAnalysis\reportAnalysisController@pagesvisitedDates');
Route::post('getLocationData', 'zAnalysis\reportAnalysisController@getLocationData');
Route::post('getuserLocationData', 'zAnalysis\reportAnalysisController@getuserLocationData');
...
Route::group(['middleware' => 'adminlocalize'], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => 'permissions:Manage Orders'], function () {
            ...
            //Reports section
            Route::get('reports', 'zAnalysis\reportAnalysisController@reportdashboard')->name('z_analysis.reportdashboard');
            Route::get('reportmap', 'zAnalysis\reportAnalysisController@reportMaps')->name('z_analysis.reportmap');
            Route::get('map/{id}', 'zAnalysis\reportAnalysisController@reportUserMaps')->name('z_analysis.reportusermap');
            Route::get('track/{id}', 'zAnalysis\reportAnalysisController@trackUser')->name('z_analysis.track');
            Route::get('stateaccess', 'zAnalysis\reportAnalysisController@stateaccess')->name('z_analysis.stateaccess');
            Route::get('pagesvisited', 'zAnalysis\reportAnalysisController@pagesvisited')->name('z_analysis.pagesvisited');
        ...
        Route::get('items/all', 'Back\ItemController@getAllItems')->name('back.items.all');
        Route::group(['middleware' => ''], function () {
            ...
            //Promotions
            //Route::get('/promotion', 'Back\PromotionController@AddPromotion');
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::prefix('user')->group(function () {
            ...
            Route::get('/seller', 'User\AccountController@seller')->name('user.seller');
            Route::get('/shopinfo', 'User\AccountController@shopinfo')->name('user.shopinfo');
            Route::get('/businessinfo', 'User\AccountController@businessinfo')->name('user.businessinfo');
            Route::get('/shippnginfo', 'User\AccountController@shippnginfo')->name('user.shippnginfo');
            Route::get('/paymentinfo', 'User\AccountController@paymentinfo')->name('user.paymentinfo');
