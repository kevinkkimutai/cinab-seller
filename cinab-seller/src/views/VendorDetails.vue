<template>
  <div class="flex flex-col w-full justify-center aligns-center items-center ">
    <div class="relative max-w-2xl border  rounded-lg shadow-lg ">
      ...
      <h2 class="mb-3 p-2 text-2xl font-bold text-gray-900 dark:text-white text-center ">Create a Seller Account</h2>
     </div>
    <form class="p-2">
     
      <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-7 max-w-4xl">
        <div>
          <label
            for="first_name"
        ...
        <div>
          <label for="licence" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
      ...
      <div>
        <button
          type="submit"
          class="text-white float-right mb-2 mt-4 bg-blue-700 px-10 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto  py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Submit
        </button>
