    ...
    <div class="w-full">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-2 mx-auto ">
            <div
                ...
                <a href="#">
                    <img class="p- rounded-t-lg w-full" src="../assets/cinab.jpg" alt="product image" />
                </a>
                <div class="mx-2 pb-1">
                    <a href="#">
...
<!-- product modal -->
<div id="popup-modal" tabindex="-1" class="hidden  md:p-56 mt-14 overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-10/12 md:inset-0 h-[calc(100%-1rem)] max-h-full md:ml-56 md:pt-20">
    <div class="relati p-4 w-auto max-w-md max-h-full">
