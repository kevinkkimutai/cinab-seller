<template>
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16 relative justify-center">
      ...
      <form @submit.prevent="submitForm">
        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
          ...
          <div class="w-full">
            <label for="price" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Price (Ksh)</label>
          ...
          <div>
            <label for="item-stock" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stock/Quantity</label>
          ...
          <div class="mt-4 sm:mt-6">
            <button
              type="submit"
              class="w-full inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-white bg-purple-800 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800"
            >
              Add product
            </button>
          </div>
