  ...
  return (
    <div className="grid gap-4">
      <div className="grid md:grid-cols-4 grid-cols-2 gap-4">
        <a href="/inventory">
          <div className="max-w-sm max-h-100 bg-primary-50 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex">
        ...
        <a href="/offers">
          ...
          <div class="max-w-sm max-h-100 bg-primary-50 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex">
