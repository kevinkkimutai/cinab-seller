...
export default function NavBar() {
  ...
  return (
    <>
      ...
      <aside
        id="logo-sidebar"
        className="fixed top-0 left-0 z-40 w-56 h-screen pt-20 transition-transform -translate-x-full bg-primary-50 border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 pb-4 overflow-y-auto bg-primary-50 dark:bg-gray-800">
