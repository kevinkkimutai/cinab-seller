              ...
              <div className="flex items-center ms-3">
                ...
                >
                  <div className="px-4 py-3" role="none">
                    <p
                      className="text-sm flex rounded-lg  items-center w-full justify-center font-medium text-gray-900 truncate dark:text-gray-300"
                      role="none"
                    >
                      {userRole}
                    </p>
                  ...
                  <ul className="py-1" role="none">
                    ...
                    <li>
                      <button
                        ...
                        className=" px-4 py-2 w-full flex items-start text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                        role="menuitem"
                      >
                        Sign out
                      </button>
