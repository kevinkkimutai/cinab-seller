  ...
  return (
    <div className="w-full h-full max-h-full overflow-y-auto">
      <div className="title text-center">
        <h3 className="text-black dark:text-white font-bold text-md md:text-3xl underline pb-3">
          ...
          <div className="mx-2 pb-1">
            <a href="#">
              <h5 className="text-md tracking-tight text-center text-gray-900 dark:text-white">
                Apple Watch Series 7 GPS, Alumini Case, Starlight{" "}
              </h5>
            </a>
            <div className="flex items-center mt-2.5 mb-2">
              ...
              <span className="text-sm text-blue-500 dark:text-white ms-1">
                <span>Ksh:</span> 599
              </span>
            </div>
