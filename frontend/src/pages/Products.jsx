        ...
        <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
            ...
            <span className="sr-only">Next</span>
                ...
                <div className="mx-2 pb-1">
                    <a href="#">
                        <h5 className="text-md tracking-tight text-center text-gray-900 dark:text-white">Apple Watch Series 7
                            GPS, Alumini Case, Starlight </h5>
                    </a>
                    <div className="flex items-center mt-2.5 mb-2">
                        <div className="flex items-center space-x-1 rtl:space-x-reverse text-gray-800 dark:text-white">
                            Stock
                        </div>
                        <span
                            className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.2 rounded dark:bg-blue-200 dark:text-blue-800 ms-1">
                            50
                        </span>
                            <span className="text-sm text-blue-500 dark:text-white ms-1"><span>Ksh:</span> 599</span>
                    </div>
                    <div className="flex items-center grid md:grid-cols-2 ">
                       ...
                       <div className="grid  justify-center grid-cols-2 gap-2 mx-2 md:mx-0 pt-2 md:pt-1">
                        ...
                        <a href="#"
                        className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg px-3 py-1 text-xs text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                        Delete
                        </a>
                       </div>
                    </div>
    ...
    <div className="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div className="grid gap-2 sm:grid-cols-2 sm:gap-6 p-4">
          ...
          <div className="w-full">
            ...
            <input type="text" name="brand" id="brand" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Product brand" required=""/>
          </div>
          <div>
          ...
          <div className="w-full">
            ...
            <input type="number" name="price" id="price" className="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="3000" required="" />
          </div>
          <div>
