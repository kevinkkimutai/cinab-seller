...
export default function UploadForm() {
  ...
  formDataToSend.append("specification_name", formData.specification_name);
  formDataToSend.append("specification_description", formData.specification_description);
        ...
        <div className="bg-gray-200 dark:bg-gray-500 rounded-lg mt-4 p-1">
              ...
              <div className="sm:col-span-2 mb-2">
                ...
                <input
                  ...
                  id="spec_name"
                  value={formData.specification_name}
                  onChange={handleInputChange}
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  placeholder="Type specification name"
                  required
                />
              </div>
              <div className="sm:col-span-2">
