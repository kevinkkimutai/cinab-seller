...
export default function ProductsForm() {
  ...
  return (
    <div className="h-full bg-slate-50 max-h-full w-full overflow-auto scrollbar-hidden shadow-lg rounded-lg border-1 border-slate-400">
          ...
          <div className="w-full">
            ...
            >
              <div className="gap-4 sm:gap-6 mb-2 md:w-4/6">
                <div className="bg-primary-50 dark:bg-gray-500  shadow-lg   rounded-lg  p-1">
                ...
                {/* image section */}
                <div className="bg-primary-50 dark:bg-gray-500  shadow-lg   rounded-lg mt-4 p-1">
                  <div>
                    <label
                      className="block mb-1 text-sm font-medium text-gray-900 dark:text-white"
                      htmlFor="image"
              ...
              <div className="md:w-3/6">
                ...
                {/* category secton */}
                <div className="bg-primary-50 dark:bg-gray-500  shadow-lg   rounded-lg mt-5 p-1">
                  <div className="mb-2">
                    <label
                      htmlFor="category"
                      className="block mb-1 text-sm font-medium text-gray-900 dark:text-white"
                ...
                {/* submit buttons */}
                <div className="bg-primary-50 dark:bg-gray-500  shadow-lg   rounded-t grid grid-cols-2 gap-4 p-1 mt-3">
                  <button
                    type="submit"
